...
function isSupportedChannel(channel: { type?: number; isDM?: () => boolean; isGroupDM?: () => boolean; isMultiUserDM?: () => boolean } | null | undefined): boolean {
    ...
    if (type === ChannelTypes.DM) return false;
