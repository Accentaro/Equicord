...
import { createGoogleFontUrl, getFontFamilyCss, loadGoogleFont } from "./utils/fonts";
...
export { createGoogleFontUrl, loadGoogleFont };
    ...
    openModal(modalProps => (
        <Modal
            ...
            onConfirm={async transform => {
                ...
                try {
                    await loadGoogleFont(resolvedTransform.fontFamily);
