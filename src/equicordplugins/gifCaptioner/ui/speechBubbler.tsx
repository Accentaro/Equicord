...
interface SpeechBubbleTransform {
    enabled: boolean;
    tipBase: number;
    tipX: number;
    tipY: number;
...
type SpeechBubbleOnSubmit = (callback: () => SpeechBubbleTransform) => void;

export default function SpeechBubbler({ width, height, element, onSubmit }:
    { width: number, height: number, element: HTMLElement, onSubmit: SpeechBubbleOnSubmit; }) {
